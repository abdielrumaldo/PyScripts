...
if __name__ == "__main__":
    ...
    pseudoColor = './test_truth_images/Pseudocolor.png'
    gt1 = './test_truth_images/gt_A.png'
    gt2 = './test_truth_images/gt_B.png'
    saveTo = r'C:\Users\yifal\Desktop\ePOC\epoc1A\maskAgreement\test_truth_images\merge\merged_mask.png'
    threshold = 0.6
    
    res = process_two_gt(pseudoColor,gt1,gt2,saveTo,threshold)
    print(res)
